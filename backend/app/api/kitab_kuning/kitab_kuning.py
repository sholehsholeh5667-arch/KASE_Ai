...
# Untuk sekarang ditetapkan di D:\KITAB
# Nanti dapat dipindahkan ke settings/config.
KITAB_ROOT = Path(
    r"D:\KITAB"
)
...
# ============================================================
# HELPER: AMBIL METADATA DARI MYSQL
# ============================================================
...
def get_book_pages(
    ...
    size: int = Query(
        ...
        ge=1,
        le=100,
        description="Jumlah halaman per request",
    ),
    db: Session = Depends(get_db),
    current_user=Depends(
        require_permission(
...
def get_book_page(
    ...
    if result is None:
        ...
        raise HTTPException(
            status_code=404,
            detail="Halaman kitab tidak ditemukan.",
        )
